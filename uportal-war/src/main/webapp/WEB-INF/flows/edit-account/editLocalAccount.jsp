                        ...
                        <c:forEach items="${ accountForm.customAttributes }" var="attribute">
                            <tr>
                                ...
                                <td class="attribute-name">
                                    ...
                                    <strong><spring:message code="attribute.displayName.${attrName}"
                                                            text="${attrName}"/></strong>
                                    ...
                                    <c:choose>
                                        <c:when test="${ fn:length(attribute.value.value) > 0 }">
                                            <c:forEach var="value" items="${ attribute.value.value }">
                                                <div>
                                                    <input type="text"
                                                           name="attributes['${fn:escapeXml(attribute.key)}'].value"
                                                           value="${ fn:escapeXml(value )}"/>
                                                    <a class="delete-attribute-value-link"
                                                       href="javascript:;"><spring:message code="remove"/></a>
                                                </div>
                                            </c:forEach>
                                            <a class="add-attribute-value-link" href="javascript:;"
                                               paramName="${fn:escapeXml(name)}">
                                ...
                                <td><a class="delete-attribute-link" href="javascript:;"><spring:message
                                        code="remove"/></a></td>
                            </tr>
                        </c:forEach>
            ...
            <div class="portlet-section" role="region">
                <div class="content">
                    ...
                    <div class="buttons">
                        ...
                        <c:choose>
                            <c:when test="${ accountForm.id < 0 }">
                                <input class="button" type="submit" value="<spring:message code="cancel"/>"
