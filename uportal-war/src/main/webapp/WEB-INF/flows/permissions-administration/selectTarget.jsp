...
<div class="fl-widget portlet prm-mgr" role="section">
    ...
    <div role="sectionhead" class="fl-widget-titlebar titlebar portlet-titlebar">
        ...
        <h2 class="title" role="heading"><spring:message code="add.assignment.to"/> <span
                class="name">${ fn:escapeXml(activity.name )}</span></h2>
        ...
        <div class="portlet-form">
            <form id="${n}targetForm" action="${ formUrl }" method="POST">
                ...
                <div id="${n}targetSuggest" class="target-input">
                    <input class="up-autocomplete-searchterm" type="text" name="targetDisplayName"
                           value="<spring:message code="target"/>" autocomplete="off"/>
                    ...
                    <div class="up-autocomplete-dropdown">
                        ...
                        <div class="up-autocomplete-close"><a href="javascript:;"><spring:message code="close"/></a>
                        </div>
                    </div>
                </div>
                ...
                <!-- Buttons -->
                <div class="buttons">
                    <input class="button primary" type="submit" value="<spring:message code="submit"/>"
                           name="_eventId_editPermission"/>
