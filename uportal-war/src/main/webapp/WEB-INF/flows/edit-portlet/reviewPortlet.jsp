    ...
    <div class="content">
        ...
        <table class="portlet-table" summary="<spring:message code="this.table.lists.portlet.configurations"/>">
            ...
            <tr>
                ...
                <td><a href="${ basicInfoUrl }" title="${ fn:escapeXml(portlet.title )}"
                       class="pa-edit">${ fn:escapeXml(portlet.title )}</a></td>
            </tr>
            <tr>
                <td class="fl-text-align-right"><spring:message code="portlet.name"/>:</td>
                <td><a href="${ basicInfoUrl }" title="${ fn:escapeXml(portlet.name )}"
                       class="pa-edit">${ fn:escapeXml(portlet.name )}</a></td>
            </tr>
            <tr>
                <td class="fl-text-align-right"><spring:message code="portlet.functional.name"/>:</td>
                <td><a href="${ basicInfoUrl }" title="${ fn:escapeXml(portlet.fname )}"
                       class="pa-edit">${ fn:escapeXml(portlet.fname )}</a></td>
            </tr>
            <tr>
                <td class="fl-text-align-right"><spring:message code="portlet.description"/>:</td>
                <td><a href="${ basicInfoUrl }" title="${ fn:escapeXml(portlet.description )}"
                       class="pa-edit">${ fn:escapeXml(portlet.description )}</a></td>
            </tr>
            <tr>
                <td class="fl-text-align-right"><spring:message code="portlet.timeout"/>:</td>
                <td><a href="${ basicInfoUrl }" title="${ fn:escapeXml(portlet.timeout )}"
                       class="pa-edit">${ fn:escapeXml(portlet.timeout )}</a></td>
            </tr>
            <tr>
                ...
                <td>
                    <c:forEach items="${ portletTypes }" var="type">
                        <c:if test="${ type.key.id == portlet.typeId }">
                            <a href="${ chooseTypeUrl }" title="${ fn:escapeXml(portlet.typeId )}"
                               class="pa-edit">${ fn:escapeXml(type.key.name )}</a>
                        </c:if>
                    </c:forEach>
                </td>
            </tr>
            <tr>
                ...
                <td><a href="${ basicInfoUrl }" title="${ fn:escapeXml(portlet.editable )}"
                       class="pa-edit">${ fn:escapeXml(portlet.editable )}</a></td>
            </tr>
            <tr>
                <td class="fl-text-align-right"><spring:message code="help"/>:</td>
                <td><a href="${ basicInfoUrl }" title="${ fn:escapeXml(portlet.hasHelp )}"
                       class="pa-edit">${ fn:escapeXml(portlet.hasHelp )}</a></td>
            </tr>
            <tr>
                <td class="fl-text-align-right"><spring:message code="about"/>:</td>
                <td><a href="${ basicInfoUrl }" title="${ fn:escapeXml(portlet.hasAbout )}"
                       class="pa-edit">${ fn:escapeXml(portlet.hasAbout )}</a></td>
            </tr>
            </tbody>
        </table>
            ...
            <c:forEach items="${ cpd.steps }" var="step">
                <c:forEach items="${ step.parameters }" var="parameter">
                    <c:if test="${ parameter.parameterInput.value.display != 'HIDDEN' && (portlet.parameters[parameter.name].value != null && portlet.parameters[parameter.name].value != '') }">
                        <tr>
                            <td class="fl-text-align-right"><spring:message code="${ parameter.label }"
    ...
    <div class="content">
        ...
        <table class="portlet-table" summary="<spring:message code="portlet.lifecycle.information"/>">
            ...
            <tr>
                ...
                <td><a href="${ lifecycleUrl }"
                       title="<spring:message code="lifecycle.name.${ portlet.lifecycleState }"/>"
                       class="pa-edit"><spring:message code="lifecycle.name.${ portlet.lifecycleState }"/></a></td>
            </tr>
            <c:if test="${ (portlet.lifecycleState != 'PUBLISHED' && portlet.lifecycleState != 'EXPIRED') && portlet.publishDate != null }">
                <tr>
                    ...
                    <td><a href="${ lifecycleUrl }" title="${ fn:escapeXml(publishDate )}"
                           class="pa-edit">${ fn:escapeXml(publishDate )}</a></td>
                </tr>
            </c:if>
            <c:if test="${ portlet.lifecycleState != 'EXPIRED' && portlet.expirationDate != null }">
                <tr>
                    ...
                    <td><a href="${ lifecycleUrl }" title="${ fn:escapeXml(expirationDate )}"
                           class="pa-edit">${ fn:escapeXml(expirationDate )}</a></td>
                </tr>
            </c:if>
            </tbody>
        </table>
