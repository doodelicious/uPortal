...
<div class="fl-widget portlet" role="section">
    ...
    <div class="fl-widget-content portlet-body" role="main">
        ...
        <div id="${n}" class="portlet-section" role="region">
            ...
            <div id="${n}_titleTemplate" style="display: none"><spring:message code="report.titleWithSingularFields"
                                                                               arguments="${reportNameStr}"/></div>
            ...
            <div class="portlet-section-body">
                <div>
                    ...
                    <p id="${n}_chartLoading" class="portlet-msg-info" style="display: none">
                        ...
                        <img alt="${loadingStr} ..."
                             src="${renderRequest.contextPath}/media/skins/universality/common/images/loading.gif">
