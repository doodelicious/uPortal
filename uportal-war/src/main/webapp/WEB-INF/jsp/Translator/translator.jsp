...
<div class="fl-widget portlet" id="${ns}container">
    <form id="${ns}form" class="portlet-form" style="position: relative;">
        ...
        <spring:message code="translate.x.into.y" arguments="${entityTypeSelection},${localeSelection}"
                        htmlEscape="false"/>
    </form>
    ...
    <div class="uptrans-form-container-wrapper">
        <div class="uptrans-form-container" id="${ns}formContainer">
            ...
            <form action="${resourceUrl}" id="${ns}portletForm">
                <h3>
                    <spring:message code="translating.portlet.definition"/>: <span
                        class="uptrans-pfrm-orig-title"></span>
                </h3>

                <div class="portlet-form">
                    <fieldset>
                        <div><label><spring:message code="title"/>:</label> <span
                                class="uptrans-pfrm-orig-title"></span></div>
                        <div><input type="text" name="title" class="uptrans-pfrm-loc-title"/></div>
                    </fieldset>

                    <fieldset>
                        <div><label><spring:message code="name"/>:</label> <span class="uptrans-pfrm-orig-name"></span>
                        </div>
                        <div><input type="text" name="name" class="uptrans-pfrm-loc-name"/></div>
                    </fieldset>

                    <fieldset>
                        <div><label><spring:message code="description"/>:</label> <span
                                class="uptrans-pfrm-orig-descr"></span></div>
