...
<div class="fl-widget portlet error view-detailed" role="section">
    ...
    <div class="fl-widget-titlebar titlebar portlet-titlebar" role="sectionhead">
        ...
        <div class="breadcrumb">
            ...
            <span class="breadcrumb-1"><a href="${ adminRetryUrl }"><spring:message
                    code="errorportlet.retry"/></a></span>
            <span class="breadcrumb-2"><a href="${ userResetUrl }"><spring:message code="errorportlet.reset"/> (User
                Facing)</a></span>
        </div>
        <!-- end breadcrumbs -->
    </div>
    ...
    <div class="fl-widget-content fl-fix up-portlet-content-wrapper">
        ...
        <div id="${n}stacktracecontainer">
            <p>
                <button class="stacktracetoggle"><spring:message code="errorportlet.toggleshow"/></button>
            </p>
